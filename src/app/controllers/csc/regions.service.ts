...
import { UpdateRegionDTO } from './dto';
...
export class RegionsService {
    ...
    updateOne(regionId: number, payload: UpdateRegionDTO): Promise<RegionEntity> {
        return this.regionRepository.save({ id: regionId, ...payload });
    }
